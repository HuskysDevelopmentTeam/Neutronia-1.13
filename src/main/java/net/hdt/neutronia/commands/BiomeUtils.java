...
public class BiomeUtils {
    ...
    static BlockPos spiralOutwardsLookingForBiome(ICommandSource sender, World world, Biome biomeToFind, double startX, double startZ, int timeout) {
    ...
    private static String getBiomeName(Biome biome) {
        if (biome != null) {
            final String original = biome.getDisplayName().getString();
