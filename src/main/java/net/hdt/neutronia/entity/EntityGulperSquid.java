...
public class EntityGulperSquid extends EntityWaterMob {
    ...
    public EntityGulperSquid(World worldIn) {
        super(NEntityTypes.GULPER_SQUID, worldIn);
    ...
    static class AIMoveRandom extends EntityAIBase {
        private final EntityGulperSquid squid;

        public AIMoveRandom(EntityGulperSquid p_i45859_1_) {
