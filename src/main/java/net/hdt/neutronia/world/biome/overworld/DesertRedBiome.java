...
public class DesertRedBiome extends Biome {
    ...
    public DesertRedBiome() {
        super((new BiomeBuilder()).surfaceBuilder(new CompositeSurfaceBuilder<>(NBiomeUtils.RED_DESERT_SURFACE_BUILDER, NBiomeUtils.RED_SAND_SURFACE)).precipitation(RainType.NONE).category(Category.DESERT).depth(0.125F).scale(0.05F).temperature(2.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent(null));
