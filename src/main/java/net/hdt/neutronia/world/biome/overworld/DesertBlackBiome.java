...
public class DesertBlackBiome extends Biome {
    ...
    public DesertBlackBiome() {
        super((new BiomeBuilder()).surfaceBuilder(new CompositeSurfaceBuilder<>(DEFAULT_SURFACE_BUILDER, NBiomeUtils.BLACK_SAND_SURFACE)).precipitation(RainType.NONE).biomeCategory(Category.DESERT).depth(0.125F).scale(0.05F).temperature(2.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent(null));
